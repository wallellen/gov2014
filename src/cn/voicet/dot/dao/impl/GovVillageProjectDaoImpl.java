	...
	public void saveVillageProjectInfo(final DotSession ds, final GovVillageProjectForm govVillageProjectForm, final String crid) {
		getHibernateTemplate().execute(new HibernateCallback() {
			public Object doInHibernate(Session session) throws HibernateException,
				...
				cs.setString(6, govVillageProjectForm.getVptxt()[2]);
				cs.setString(7, govVillageProjectForm.getVptxt()[3]);
				cs.setString(8, govVillageProjectForm.getVptxt()[4]);
				cs.setString(9, govVillageProjectForm.getVptxt()[5]);
				cs.setString(10, govVillageProjectForm.getVptxt()[6]);
				cs.setString(11, govVillageProjectForm.getVptxt()[7]);
				cs.setString(12, govVillageProjectForm.getVptxt()[8]);
				cs.setString(13, govVillageProjectForm.getVptxt()[9]);
				cs.setString(14, govVillageProjectForm.getVptxt()[10]);

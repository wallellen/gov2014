...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/script/validatepass.js"></script>
	<script type="text/javascript">
		...
		/*window.onbeforeunload = function(){
			$.ajax({
	            type: "POST",
	            url: 'system/dotMenuAction_closeWindow.do',
	            dataType: "json",
	            data: '',
	            success: function(){},
	            error: function(){}
    ...
    <!-- nav -->
  	<div id="nav">
        ...
        <div class="nav-right">
            ...
            <span><a href="${pageContext.request.contextPath }/system/dotMenuAction_logout.do" onclick="return confirm('你确定要注销吗?')" target="_top">[&nbsp;注销&nbsp;]</a></span>
        </div>
    </div>
    <!-- main -->
  	<div id="main">
  	...
  	<div id="footer">
        ...
        <span>Copyright @ 2005-2014 All Rights Reserved 版权所有 · 南京威帝通讯科技有限公司&nbsp;&nbsp;V140610</span>

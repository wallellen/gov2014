...
<h3 class="jiangbu-title">省级后方单位挂钩帮扶情况&nbsp;[<s:property value="xianName"/>]</h3>
...
<table class="data_list" cellpadding="0" cellspacing="0" width="100%">
   	...
   	<tr>
        ...
        <td rowspan="3" width="8%">
        	<p>
        	<input type="button" value="导出" onclick="location.href='${pageContext.request.contextPath }/system/govBangfuAction_exportWithXianDetail.do?xm=<s:property value="xm"/>&rid=<s:property value="rid"/>&title=<s:property value="title"/>&byxian=<s:property value="byxian"/>&xianName=<s:property value="xianName"/>'" class="button43"/>
        	</p>
        	<p>&nbsp;</p>
        	<p>
    ...
    <tr style="display:none" title="省级后方单位名称: <s:property value='#ls.c1'/>&#10;所在乡镇名称: <s:property value='#ls.c2'/>&#10;挂钩村名称: <s:property value='#ls.c3'/>">
        ...
        <td><s:property value="#ls.c2.length()>4?#ls.c2.substring(0,3)+'...':#ls.c2"/></td>
        <td><s:property value="#ls.c3.length()>4?#ls.c3.substring(0,3)+'...':#ls.c3"/></td>

...
<table class="data_list" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr style="display:none">
        ...
        <td>
        	...
        	<a href="${pageContext.request.contextPath }/system/govVillageProjectAction_writeReportCun.do?crid=<s:property value="crid"/>&title=<s:property value="title"/>&sdt=<s:property value="sdt"/>&edt=<s:property value="edt"/>&navbm=<s:property value='#ls.c0'/>">进入</a>
        	</s:if>
        	<s:else>
        	<a href="${pageContext.request.contextPath }/system/govVillageProjectAction_gotoZhenLevel.do?crid=<s:property value="crid"/>&navbm=<s:property value="#ls.c0"/>&title=<s:property value="title"/>&sdt=<s:property value="sdt"/>&edt=<s:property value="edt"/>">进入</a>
        	</s:else>
        </td>
    </tr>
    </s:iterator>

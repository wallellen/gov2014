...
<table class="data_list" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr style="display:none">
        ...
        <td>&nbsp;</td>
        <td>
        	<a href="${pageContext.request.contextPath }/system/govKeyProjectAction_viewKeyProjectList.do?navbm=${navbm }&pianId=${ls.bm }&crid=${crid }&title=${title }&sdt=${sdt }&edt=${edt }&areaName=${ls.oname }">查看详细</a>
        </td>
	</tr>
	</c:forEach>
	</tbody>
...
<table class="data_list" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr style="display:none">
		...
		<td>${ls.pqname }</td>
		<td>
        	<a href="${pageContext.request.contextPath }/system/govKeyProjectAction_writeReportZhen.do?navbm=${navbm }&pianId=${ls.pqid }&crid=${crid }&title=${title }&sdt=${sdt }&edt=${edt }&areaName=${ls.pqname }">查看详细</a>
        </td>
	</tr>
	</c:forEach>
	</tbody>

...
<table class="data_list" cellpadding="0" cellspacing="0" width="100%">
   	...
   	<tr>
        ...
        <td rowspan="3" width="8%">
        	<p>
        	<input type="button" value="导出" onclick="location.href='${pageContext.request.contextPath }/system/govBangfuAction_exportWithDeptDetail.do?fuid=<s:property value="fuid"/>&title=<s:property value="title"/>&byunit=<s:property value="byunit"/>&deptName=<s:property value="deptName"/>'" class="button43"/>
        	</p>
        	<p>&nbsp;</p>
        	<p>

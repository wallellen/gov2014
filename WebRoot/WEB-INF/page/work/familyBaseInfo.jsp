...
<form name="personForm" action="${pageContext.request.contextPath }/system/govBrowerAction_saveFamily.do" method="post" onsubmit="return checkPersonForm()">
<div id="base-info">
	<ul class="info1">
        ...
        <li>身份证号码：<input type="text" id="idcno" name="idcno" value="<s:property value="#session.vts.map.idcno"/>" maxlength="18" onfocus="this.className='input_on'" onblur="checkIDCard()"/></li>
        <li>联系电话：<input type="text" id="htel" name="htel" value="<s:property value="#session.vts.map.telnum"/>" maxlength="15" onfocus="this.className='input_on'" onblur="checkTelphone()"/></li>
	</ul>
    <ul class="info2">
        ...
        <li>住房面积(m<sup>2</sup>)：<input type="text" id="house" name="house" value="<s:property value="#session.vts.map.house"/>" maxlength="5" onfocus="this.className='input_on'" onblur="checkHouse()"/></li>
...
<div id="base-info2">
    <ul class="info3">
        <li class="input1">挂钩帮扶人：<input type="text" id="frname" name="frname" value="<s:property value="#session.vts.map.frname"/>" maxlength="10" onfocus="this.className='input_on'" onblur="checkBanfPerson()"/></li>
        <li class="input1">单位职务：<input type="text" id="frwork" name="frwork" value="<s:property value="#session.vts.map.frwork"/>" maxlength="10" onfocus="this.className='input_on'" onblur="checkBanfWork()"/></li>
        <li class="input1">帮扶人联系电话：<input type="text" id="frtel" name="frtel" value="<s:property value="#session.vts.map.frtel"/>" maxlength="15" onfocus="this.className='input_on'" onblur="checkBanfTelphone()"/></li>
        <li>

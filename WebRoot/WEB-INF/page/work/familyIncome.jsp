...
<div id="member-info-ul">
	<ul>
		<li><a href="${pageContext.request.contextPath }/system/govBrowerAction_itemFamily.do">家庭成员信息</a></li>
		<li style="background:url(../images/tab-bg2.png); color:#FFF;">家庭收入及帮扶情况</li>
	</ul>
</div>

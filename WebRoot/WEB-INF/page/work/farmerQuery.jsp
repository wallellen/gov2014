		...
		<table class="data_list" width="100%" bordercolor="gray" border="0" cellpadding="0" cellspacing="0">
			...
			<tbody id="splitpage">
				...
				<tr align="center" style="height:20px; display:none;">
					...
					<td title="<s:property value='#ls5.c1'/>"><s:property value="#ls5.c1.length()>26?#ls5.c1.substring(0,25)+'...':#ls5.c1"/></td>
					<td title="<s:property value='#ls5.c2'/>"><s:property value="#ls5.c2.length()>7?#ls5.c2.substring(0,6)+'...':#ls5.c2"/></td>
					<td class="tabtd1">
